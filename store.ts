...
// Question Bank Organized by Lessons
export const LESSON_CATALOG: Record<string, LessonData> = {
    'warmup': {
        id: 'warmup',
        title: '暖身練習題',
        questions: [
            { id: 1001, question: "「ㄘㄞˇ」虹", options: ["採", "彩", "踩"], correctIndex: 1 },
            { id: 1002, question: "「ㄆㄥ」然心動", options: ["怦", "砰", "抨"], correctIndex: 0 },
            { id: 1003, question: "一「ㄓㄢˇ」燈", options: ["展", "斬", "盞"], correctIndex: 2 },
            { id: 1004, question: "「ㄓㄨˋ」立", options: ["佇", "注", "住"], correctIndex: 0 },
            { id: 1005, question: "斑「ㄅㄛˊ」", options: ["伯", "駁", "博"], correctIndex: 1 },
        ]
    },
    'L1': {
        id: 'L1',
        ...
        questions: [
            ...
            { id: 104, question: "「ㄘㄨㄣˋ」步難行", options: ["吋", "寸", "村"], correctIndex: 1 },
            ...
            { id: 108, question: "「ㄕˊ」誠", options: ["十", "實", "時"], correctIndex: 1 },
            { id: 109, question: "「ㄊㄢˊ」琴", options: ["談", "彈", "壇"], correctIndex: 1 },
            { id: 110, question: "快「ㄌㄜˋ」", options: ["垃", "圾", "樂"], correctIndex: 2 },
            { id: 111, question: "「ㄊㄚ」們(物品)", options: ["牠", "它", "他"], correctIndex: 1 },
            { id: 112, question: "「ㄉㄨㄢˇ」長", options: ["斷", "短", "段"], correctIndex: 1 },
    ...
    'L2': {
        ...
        questions: [
            ...
            { id: 205, question: "「ㄧㄝˋ」作", options: ["葉", "業", "夜"], correctIndex: 1 },
            { id: 206, question: "「ㄨˇ」中", options: ["五", "午", "舞"], correctIndex: 1 },
    ...
    'L3': {
        ...
        questions: [
            ...
            { id: 313, question: "「ㄘˇ」因", options: ["此", "疵", "磁"], correctIndex: 0 },
            { id: 314, question: "「ㄓㄨㄣˇ」備", options: ["準", "准", "隼"], correctIndex: 0 },
            { id: 315, question: "準「ㄅㄟˋ」", options: ["倍", "備", "背"], correctIndex: 1 },
        ]
    },
    'L4': {
        id: 'L4',
        ...
        questions: [
            ...
            { id: 414, question: "「ㄏㄨˊ」鬧", options: ["湖", "壺", "胡"], correctIndex: 2 },
    ...
    'L5': {
        ...
        questions: [
            ...
            { id: 505, question: "幾「ㄏㄜˊ」", options: ["和", "合", "河"], correctIndex: 1 },
    ...
    'L7': {
        ...
        questions: [
            ...
            { id: 703, question: "航「ㄏㄤˊ」", options: ["航", "杭", "行"], correctIndex: 0 },
            ...
            { id: 709, question: "「ㄅㄧˋ」關", options: ["畢", "必", "閉"], correctIndex: 2 },
            { id: 710, question: "深「ㄕㄣ」", options: ["身", "伸", "深"], correctIndex: 2 },
    ...
    'L8': {
        ...
        questions: [
            ...
            { id: 818, question: "垃「ㄙㄜˋ」", options: ["圾", "色", "瑟"], correctIndex: 0 },
    ...
    'L10': {
        ...
        questions: [
            ...
            { id: 1004, question: "「ㄈㄨˊ」衣", options: ["扶", "服", "符"], correctIndex: 1 },
            ...
            { id: 1009, question: "「ㄐㄧㄡˇ」喝", options: ["酒", "九", "久"], correctIndex: 0 },
            { id: 1010, question: "「ㄐㄧㄥˋ」禮", options: ["敬", "竟", "靜"], correctIndex: 0 },
            { id: 1011, question: "跳「ㄨˇ」", options: ["午", "五", "舞"], correctIndex: 2 },
            { id: 1012, question: "「ㄒㄧˊ」慣", options: ["習", "席", "昔"], correctIndex: 0 },
    ...
    'L11': {
        ...
        questions: [
            ...
            { id: 1103, question: "抽「ㄧㄢ」", options: ["菸", "煙", "淹"], correctIndex: 0 },
            ...
            { id: 1111, question: "「ㄔㄚˊ」檢", options: ["茶", "察", "查"], correctIndex: 2 },
    ...
    'L12': {
        ...
        questions: [
            ...
            { id: 1207, question: "「ㄕㄨˊ」叔", options: ["熟", "淑", "叔"], correctIndex: 2 },
...
interface GameState {
  ...
  playerProgress: number; // 0-1 within current chunk
  
  // Quiz State
  selectedLessonIds: string[];
  activeQuestions: QuizQuestion[]; // The pool to draw from
...
export const useGameStore = create<GameState>((set, get) => ({
  ...
  generateInitialTrack: () => {
    ...
    first.renderPoints = [new Vector3(0,0,-CHUNK_LENGTH), new Vector3(0,0,0), new Vector3(0,0, CHUNK_LENGTH), new Vector3(0,0, CHUNK_LENGTH*2)];
    first.items = []; 
    first.obstacles = [];
    chunks.push(first);
    prev = first;
    ...
    set({ chunks, playerChunkIndex: 0, playerProgress: 0, boostTimer: 0, penaltyTimer: 0, bonusScore: 0, competitors: [] });
  },
  ...
  startGame: () => {
    ...
    selectedLessonIds.forEach(id => {
        if (LESSON_CATALOG[id]) pool = [...pool, ...LESSON_CATALOG[id].questions];
    });
    if (pool.length === 0) pool = LESSON_CATALOG['L1'].questions;

    set({ activeQuestions: pool });
    ...
    const newCompetitors: Competitor[] = [
        { id: 'bot-1', chunkId: 0, progress: 0.8, laneOffset: -5, speed: 0.35, color: '#ff0000', modelOffset: 0 }, 
        { id: 'bot-2', chunkId: 0, progress: 0.6, laneOffset: 5, speed: 0.45, color: '#00ff00', modelOffset: 1 },  
        { id: 'bot-3', chunkId: 1, progress: 0.2, laneOffset: 0, speed: 0.50, color: '#ffff00', modelOffset: 2 }   
    ];
  ...
  togglePause: () => {
      set(state => {
          if (state.status === GameStatus.RACING) {
              soundManager.stopEngine(); // Pause engine sound
              soundManager.stopMusic();
              return { status: GameStatus.PAUSED };
          } else if (state.status === GameStatus.PAUSED) {
              soundManager.startEngine(); // Resume engine
              soundManager.startMusic();
  ...
  tickTimers: () => {
      set(state => {
          if (state.status !== GameStatus.RACING) return {}; // Stop timers when paused
          return {
  ...
  answerQuestion: (isCorrect) => {
      if (isCorrect) {
          ...
          soundManager.playSfx('boost');
          set({ boostTimer: EFFECT_DURATION, penaltyTimer: 0, feedbackMessage: "CORRECT! NITRO BOOST!" });
      } else {
          soundManager.playSfx('wrong');
          set({ boostTimer: 0, penaltyTimer: EFFECT_DURATION, feedbackMessage: "WRONG! SPEED DOWN!" });
      }
  ...
  collectCoin: (chunkId, obsId) => {
      set(state => {
          ...
          return { 
              chunks: state.chunks.map(c => c.id === chunkId ? { ...c, obstacles: c.obstacles.map(o => o.id === obsId ? { ...o, isCollected: true } : o) } : c),
  ...
  updateCompetitors: (dt: number) => {
      set(state => {
          ...
          if (aheadCount < 3) {
              ...
              const chunkId = state.playerChunkIndex + 4;
              newCompetitors.push({
                  id: `bot-${id}`,
                  chunkId: chunkId,
                  progress: 0,
  ...
  setCarPosition: (x, z, chunkIndex, progressInChunk) => {
    ...
    // Save best score persistence
    if (totalScore > bestScore) {
        localStorage.setItem('polykart-best', totalScore.toString());
    }
    ...
    set({ 
      ...
      playerProgress: progressInChunk,
      score: totalScore,
